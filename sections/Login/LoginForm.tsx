 ...
 */
"use client";
import { Flex, Image, Input, Box, Text, Button } from "@chakra-ui/react";
  ...
  return (
    <>
      <form onSubmit={handleSubmit}>
        <Box
          marginStart={{ base: "15px", lg: "106px", md: "78px" }}
          marginEnd={"48px"}
        >
          <Field
              ...
              <span style={{ color: colors.mainColor, fontWeight: "bold" }}>
                <Flex gap={2} alignItems="center">
                  ...
                  <Box>
                    ...
                    <span style={{ color: colors.mainColor }}>*</span>
                  </Box>
                </Flex>
              </span>
            }
          ...
          >
            <Input
              ...
              borderColor={errors.email ? "red" : colors.mainColor}
              color={colors.mainColor}
              focusRingColor={colors.mainColor}
              _focus={{ boxShadow: " 0px 1px 10px 0px rgba(0, 0, 0, 0.1)" }}
            />
          </Field>
          <Field
          ...
          >
            <PasswordInput
              ...
              onChange={handleChange}
              borderColor={errors.password ? "red" : colors.mainColor}
              color={colors.mainColor}
              focusRingColor={colors.mainColor}
              _focus={{ boxShadow: " 0px 1px 10px 0px rgba(0, 0, 0, 0.1)" }}
            />
        ...
        <Flex
          ...
          marginTop="20px"
        >
          <Checkbox dir="rtl" color={colors.mainColor}>
            البقاء متصلا
          </Checkbox>
        </Flex>
        <Flex
