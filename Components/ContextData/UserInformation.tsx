...
import { SignUpTypePageOne, SignUpTypePageTwo } from "../FormComponents/signUpValidationPageOne";
...
export const UserContextProvider = createContext<UserContextType | undefined>(undefined);

const UserInformation: React.FC<{children: ReactNode}> = ({ children }) => {
  const [userInformation, setUserInformation] = useState< SignUpTypePageOne | SignUpTypePageTwo>({
    userName: "",
    firstName: "",
    lastName: "",
    email: "",
